...
// ─── Reuse the same data as the parent route ──────────────────────────────────
    ...
    faq: [
      {
        ...
        answer:
          "Parce que nous avons déjà 60% de vos données dans notre système (forme juridique, secteur, localisation). Cela réduit considérablement le temps de création tout en garantissant une qualité professionnelle.",
      },
      {
        question: "Le BP Express suffit-il pour une demande de prêt bancaire ?",
        answer:
          "Oui, le BP Express est adapté aux demandes de prêt classiques. Pour des demandes plus complexes (BPI France, investisseurs, levée de fonds), nous recommandons le BP Expert ou BP Investor.",
      },
    ],
  },
  {
    ...
    faq: [
      {
        ...
        answer:
          "Non, absolument aucun. Notre modèle est 100% au succès : vous ne payez que si nous récupérons votre créance.",
      },
      {
        question: "Que se passe-t-il si le recouvrement amiable échoue ?",
        answer:
          "En cas d'échec, nous vous orientons vers notre partenaire huissier de justice. Vous ne nous devez rien, et nous vous fournissons tous les documents nécessaires.",
      },
    ],
  },
  {
    ...
    description:
      "Le dirigeant est seul et porte toutes les casquettes. Notre Copilote Entreprise est un partenaire opérationnel qui le décharge sur le commercial, la finance, la stratégie et le mindset. C'est notre service phare.",
    shortDescription:
    ...
    faq: [
      {
        ...
        answer:
          "C'est notre innovation propriétaire : un tableau de bord qui suit vos pains (points de douleur) en temps réel avec priorités, statut et actions. Vous voyez votre progression mois par mois.",
      },
      {
        question: "Sur quoi pouvez-vous m'accompagner concrètement ?",
        answer:
          "5 domaines : Commercial, Finance, RH, Stratégie et Mindset. Chaque session est adaptée à vos besoins du moment.",
      },
    ],
  },
  {
    ...
    description:
      "Les PME de 10-50 salariés n'ont pas les moyens d'embaucher un DAF. Notre DAF Externalisé offre un pilotage financier professionnel à une fraction du coût, avec la réactivité d'un partenaire qui connaît votre entreprise.",
    shortDescription:
    ...
    tiers: [
      {
        ...
        includes: [
          ...
          "Reporting financier mensuel",
          "Tableau de bord trésorerie",
          "Suivi budget + Prévisions 3 mois",
        ],
        duration: "3 mois min.",
    ...
    faq: [
      {
        ...
        answer:
          "L'expert-comptable gère la comptabilité. Le DAF Externalisé prend une dimension stratégique : pilotage de trésorerie, relation bancaire, optimisation fiscale. Ce sont deux métiers complémentaires.",
      },
    ],
  },
  {
    ...
    description:
      "Sans SEO, votre site perd 60 à 70% de son trafic potentiel. Nous optimisons votre visibilité sur Google avec une stratégie sur-mesure combinant SEO technique, contenu et netlinking.",
    shortDescription:
    ...
    faq: [
      {
        ...
        answer:
          "SEO Local : Page 1 Google sur 5 requêtes locales en 6 mois. SEO Croissance : Top 10 sur 10 mots-clés en 12 mois. SEO Dominance : Top 5 sur 15 mots-clés + trafic x3 en 12 mois.",
      },
    ],
  },
  {
    ...
    description:
      "Beaucoup de TPE n'ont pas de site web, ou ont un site obsolète. C'est le premier investissement après la création. Nous créons des sites performants, optimisés SEO et adaptés à votre activité.",
    shortDescription:
    ...
    deliverables: [
      ...
      "Formation utilisation du CMS (2h)",
    ...
    faq: [
      {
        ...
        answer:
          "Selon le besoin : WordPress + Elementor pour les vitrines, Next.js pour les performances, Shopify pour l'e-commerce, Webflow pour le design. Nous conseillons la meilleure stack.",
      },
      {
        question: "Puis-je modifier mon site moi-même ?",
        answer:
          "Oui, tous nos sites incluent un CMS admin intuitif. La formule Site Business inclut 2h de formation pour vous rendre autonome.",
      },
    ],
  },
  {
    ...
    description:
      "Le dirigeant doit tout apprendre seul. Nos formations sont conçues spécifiquement pour les dirigeants de TPE/PME et couvrent les compétences clés du quotidien entrepreneurial.",
    shortDescription:
      "Formations pratiques pour dirigeants : masterclasses en ligne, bootcamps et formations sur-mesure.",
    category: "Formation",
    priceFrom: 49,
    priceUnit: "€/session",
    icon: "GraduationCap",
    ...
    faq: [
      {
        ...
        answer:
          "LinkedIn pro, Google Ads, comptabilité TPE, prospection B2B, trésorerie, contenus qui convertissent, automatisation IA, recrutement, réseaux sociaux, négociation avancée.",
      },
      {
        question: "Les formations sont-elles adaptées aux débutants ?",
        answer:
          "Oui, chaque session part des fondamentaux et va progressivement vers des niveaux avancés avec exercices pratiques pour une mise en application immédiate.",
      },
    ],
  },
  {
    ...
    description:
      "Après la création, le dirigeant est confronté à de nombreuses obligations juridiques sans avoir les compétences ni le budget d'un avocat. Notre service offre un accès abordable à l'expertise juridique au quotidien.",
    shortDescription:
    ...
    tiers: [
      ...
      },
      {
        ...
        includes: [
          ...
          "Consultation 2h/mois",
          "Veille réglementaire + Support email",
        ],
        duration: "3 mois min.",
    ...
    faq: [
      {
        ...
        answer:
          "Nous ne sommes pas un cabinet d'avocats mais un service de conseil juridique pour TPE/PME. Pour les litiges complexes, nous coordonnons avec notre réseau d'avocats partenaires.",
      },
      {
        question: "Quels types de contrats pouvez-vous rédiger ?",
        answer:
          "CGV, devis, bail commercial, NDA, contrat de prestation, cession de droits, contrat de travail, CGU, politiques de confidentialité et bien plus.",
      },
    ],
  },
];
