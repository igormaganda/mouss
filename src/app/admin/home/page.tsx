...
const sectionConfig: SectionConfig[] = [
  ...
  { type: "audit", label: "Audit", icon: ClipboardCheck, description: "Section quiz/audit", hasItems: false },
  ...
  { type: "newsletter", label: "Newsletter", icon: Mail, description: "Section inscription newsletter", hasItems: false },
