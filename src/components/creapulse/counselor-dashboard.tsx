        ...
        <Card className="border-0 shadow-sm">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <Badge variant="secondary" className="bg-emerald-50 text-emerald-700 text-xs">GLM 4.7 — En ligne</Badge>
            </div>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-2 pt-4 border-t border-gray-100">
              <Input value={inputValue} onChange={(e) => setInputValue(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && !e.shiftKey && sendMessage()} placeholder="Posez une question à l'IA..." className="flex-1 rounded-xl border-gray-200 h-10" disabled={isLoading} />
