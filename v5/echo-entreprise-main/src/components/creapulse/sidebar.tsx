...
export default function Sidebar() {
  ...
  return (
    <motion.aside animate={{ width: sidebarOpen ? 260 : 72 }} transition={{ duration: 0.2, ease: "easeInOut" as const }} className="fixed left-0 top-0 bottom-0 z-30 bg-white border-r border-gray-100 flex flex-col overflow-hidden">
      {sidebarContent}
    </motion.aside>
  )
}
