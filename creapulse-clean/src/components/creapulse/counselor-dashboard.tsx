...
import CounselorPortfolio from './counselor-portfolio'
import CounselorPorteurFiche from './counselor-porteur-fiche'
import CounselorMessaging from './counselor-messaging'
import CounselorInterview from './counselor-interview'
import CounselorAiCopilot from './counselor-ai-copilot'
import {
  Bot,
  MessageSquareText,
  FileOutput,
    ...
    <div className="relative">
      <Tabs value={counselorTab} onValueChange={(v) => setCounselorTab(v as typeof counselorTab)} className="space-y-6">
        <TabsList className="bg-gray-100 p-1 rounded-xl h-auto flex-wrap gap-1">
          {[
            { value: 'portefeuille', icon: Users, label: 'Portefeuille' },
            { value: 'fiche-porteur', icon: User, label: 'Fiche' },
            { value: 'messagerie', icon: MessageCircle, label: 'Messagerie' },
        ...
        <TabsContent value="portefeuille"><CounselorPortfolio /></TabsContent>
        <TabsContent value="fiche-porteur"><CounselorPorteurFiche /></TabsContent>
        <TabsContent value="messagerie"><CounselorMessaging /></TabsContent>
        <TabsContent value="entretien"><CounselorInterview /></TabsContent>
        <TabsContent value="ai-copilote"><CounselorAiCopilot /></TabsContent>
      ...
      {/* Persistent AI sidebar - visible on all tabs */}
      <CounselorAiCopilot />
    </div>
  )
}
